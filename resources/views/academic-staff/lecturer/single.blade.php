                ...
                <div class="row push">
                    ...
                    <div class="col-lg-9 col-xl-7">
                        <div class="form-group row items-push mb-0">
                                    ...
                                    <label class="custom-control-label"
                                        ...
                                        <span class="d-flex align-items-center">
                                            ...
                                            <span class="ml-2">
                                                ...
                                                <span class="d-block font-size-sm text-muted">{{ $competency->code
                                                    }}</span>
                                            </span>
                                        </span>
                                    </label>
                            ...
                            @empty
                            <div class="col-md-12">
                                <x-alert type="info" icon="fa-info" message="Tidak ada data kompetensi."
                                    heading="Data Kompetensi" dismissable="Tidak Ada Data Kompetensi"></x-alert>
                            </div>
                            @endforelse
                        </div>
                    </div>
