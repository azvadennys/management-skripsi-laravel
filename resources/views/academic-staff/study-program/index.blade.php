                ...
                <div class="block-content block-content-full">
                    <form action="{{ route('study-programs.store') }}" method="POST">
                        ...
                        <div class="form-group row gutters-tiny mb-0 items-push">
                            <div class="col-md-2">
                                <x-input label="Kode Prodi" type="text" field="study_program_code"
                                    placeholder="Kode Prodi" is-required="true"></x-input>
                            </div>
                        ...
                        <div class="form-group row gutters-tiny mb-0 items-push">
                            <div class="col-md-4">
                                <x-input label="Nama Program Studi" type="text" field="name"
                                    placeholder="Nama Program Studi" is-required="true"></x-input>
                            </div>
                            <div class="col-md-4 offset-1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell">
                            ...
                            <a href="{{ route('lecturers.show', $studyProgram->leader->id) }}">{{
                                $studyProgram->leader->getNameWithDegree() }}</a>
                            @else
                            -
                            @endif
                        </td>
                        <td class="text-center">
                            <div class="btn-group btn-group-sm">
                                <button type="button" class="btn btn-primary js-tooltip-enabled" data-toggle="tooltip"
                                    title="" onclick="editStudyProgram(
                                                    '{{ $studyProgram->id }}',
                                ...
                                <button type="button" class="btn btn-danger js-tooltip-enabled" data-toggle="tooltip"
